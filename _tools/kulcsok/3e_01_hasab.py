...
"""
from sympy import Rational as R, sqrt, N, symbols, solve, Eq, tan, rad, atan, deg
...
metszet_teglatest = sqrt(6**2 + 8**2)*12
...
k4 = (8, 6*8**2, 8**3)
k5_m = solve(Eq(B(3, 8)*x, 80*sqrt(3)), x)[0]
k5_F = 2*B(3, 8) + 3*8*5
...
k12_A = R(12*8, 100) + 2*R(12*5, 100) + 2*R(8*5, 100)
k13_T = 8*sqrt(2)*6
k14_alapel = 12/sqrt(2)
k15 = (solve(Eq(2*x*8, 96), x)[0], 6*sqrt(3)*8)
k16_szog = deg(atan(1/sqrt(2)))
n1_m = 6*sqrt(2)*tan(rad(30))
n2_x = solve(Eq(2*(2*x**2 + 3*x**2 + 6*x**2), 88), x)[0]
n3_a = solve(Eq(x**2*sqrt(2), 50*sqrt(2)), x)[0]
n3 = (n3_a, 6*n3_a**2, n3_a**3)
...
TESZT = {
    ...
    'alap-18': [('', k(metszet_negyzetes))],
    'alap-19': [('', 10), ('', int(metszet_teglatest))],
    ...
    'kozep-4': [('', k4[0]), ('', k4[1]), ('', k4[2])],
    'kozep-5': [('', int(k5_m)), ('', k(k5_F))],
    'kozep-6': [('', int(k6_m))],
    ...
    'kozep-10': [('', int(k10_V))],
    'kozep-11': [('', k(k11_V))],
    'kozep-12': [('', int(k12_l)), ('', float(k12_A))],
    'kozep-13': [('', k(k13_T))],
    'kozep-14': [('', 12), ('', k(k14_alapel))],
    'kozep-15': [('', int(k15[0])), ('', k(k15[1]))],
    'kozep-16': [('', k(k16_szog))],
    'nehez-1': [('', k(n1_m))],
    'nehez-2': [('', int(n2_x)), ('', 4), ('', 6), ('', 48)],
    'nehez-3': [('', k(n3[0])), ('', int(n3[1])), ('', k(n3[2]))],
    'nehez-4': [('', int(n4_a))],
    'nehez-5': [('', 2), ('', 3), ('', 4), ('', 9)],
    'joker':   [('', k(joker_T))],
}
