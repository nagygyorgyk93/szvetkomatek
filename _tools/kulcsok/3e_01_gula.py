...
a3_rho, a3_mo = r_ap(4, 8), h_o(4, 8, 3)
a4_b = sqrt(4**2 + 3**2)
a8_F = B(3, 6) + M(3, 6, 8)
a9_F = B(6, 4) + M(6, 4, 6)
a11_m = solve(Eq(25*x/3, 100), x)[0]
a13 = (r_ap(4, 10), h_o(4, 10, 12), M(4, 10, 13), B(4, 10) + M(4, 10, 13), V(4, 10, 12))
...
k3 = (h_o(4, 16, 6), M(4, 16, 10), B(4, 16) + M(4, 16, 10))
k4_a = solve(Eq(B(4, x)*9/3, 300), x)[0]
k5 = (h_o(6, 4, 2), B(6, 4) + M(6, 4, 4), V(6, 4, 2))
k6 = (B(3, 12), V(3, 12, 5))
